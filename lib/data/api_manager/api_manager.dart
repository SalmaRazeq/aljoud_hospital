...
class ApiManger {
  // http://192.168.1.7/c43/Select-Doctor.php
  // http://localhost/c43/Select-doctor-Specialty.php?Specialty=Neurology
  ...
  static Future<DoctorResponse?> fetchDoctorsBySpecialty(String specialty) async {
    try {
      const String apiUrl = 'http://192.168.1.7/c43/Select-doctor-Specialty.php';
